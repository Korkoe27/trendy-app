        ...
        <div class="overflow-x-auto">
            <table class="min-w-full divide-y divide-gray-200">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    @empty
                    <tr>
                        <td colspan="5" class="px-6 py-4 whitespace-nowrap text-base text-gray-500 text-center">
                            No users found.
                        </td>
                    </tr>
                    @endforelse
            ...
            <form wire:submit.prevent="saveUser">
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        @error('username') <div class="text-red-500 text-xs mt-1">{{ $message }}</div> @enderror
                    </div>
            ...
            <div class="space-y-4">
                <div class="grid grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <p class="mt-1">
                            <span class="inline-block px-2 py-1 text-xs font-medium rounded-full {{ $viewUser->is_active ? 'text-green-600 bg-green-100' : 'text-gray-600 bg-gray-100' }}">
                    ...
                    <div>
                        ...
                        <p class="mt-1 text-base text-gray-900">{{ $viewUser->created_at->format('M j, Y h:i A') }}</p>
                    </div>
                </div>
            ...
            <form wire:submit.prevent="saveRole">
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        @error('roleName') <div class="text-red-500 text-xs mt-1">{{ $message }}</div> @enderror
                    </div>
                    ...
                    <div>
                        ...
                        @error('roleDescription') <div class="text-red-500 text-xs mt-1">{{ $message }}</div> @enderror
                    </div>
                </div>
        ...
        <div class="bg-white rounded-lg p-6 w-full max-w-4xl mx-4 max-h-[90vh] overflow-y-auto">
            <div class="flex justify-between items-center mb-6">
                <div>
                    ...
                    <p class="text-sm text-gray-600 mt-1">Role: <span class="font-medium uppercase">{{ $selectedRoleName }}</span></p>
                </div>
